            ...
            {items.map((item, i) => {
              ...
              return (
                <motion.div
                  key={item.id}
                  className={cn(
                    "absolute bottom-0 rounded-[2rem] border-4 border-white/5 bg-dark-900 overflow-hidden shadow-2xl",
    ...
    <div className="relative h-full w-full">
      ...
      <div className="absolute inset-0">
        {item.imageSrc ? (
          ...
          <div className="flex h-full w-full items-center justify-center bg-dark-800 text-sm text-gray-500">
            No image
          </div>
        )}
      </div>
      ...
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-dark-900/95 via-dark-900/40 to-transparent" />
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-8">
        ...
        {item.description ? (
          <div className="line-clamp-3 text-sm text-gray-300 leading-relaxed max-w-sm">
            {item.description}
          </div>
        ) : null}
      </div>
