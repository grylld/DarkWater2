...
export function LocationMap({
  ...
  coordinates = "29.7712° S, 30.7675° E",
  className,
}: LocationMapProps) {
  ...
  return (
    ...
    >
      <motion.div
        className="relative overflow-hidden rounded-[2rem] bg-dark-900 border border-white/10 w-full h-full"
        style={{
          ...
          {isExpanded && (
            ...
            >
              ...
              >
                ...
                >
                  <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z" fill="#84cc16" />
                  <circle cx="12" cy="9" r="2.5" className="fill-dark-900" />
                </svg>
              </motion.div>
        ...
        <div className="relative z-10 h-full flex flex-col justify-between p-6">
          ...
          <div className="flex items-start justify-between">
            ...
            >
              ...
              <span className="text-[10px] font-bold text-gray-400 tracking-wider uppercase">Live</span>
            </motion.div>
          </div>
          ...
          <div className="space-y-1.5 mt-auto">
            ...
            {/* Animated underline */}
            <motion.div
              className="h-px bg-gradient-to-r from-lime-500/80 via-lime-500/30 to-transparent"
      ...
      {/* Click hint */}
      <motion.p
        className="absolute -bottom-7 left-1/2 text-xs text-gray-500 font-medium tracking-wide whitespace-nowrap"
        style={{ x: "-50%" }}
        initial={{ opacity: 0 }}
        animate={{
